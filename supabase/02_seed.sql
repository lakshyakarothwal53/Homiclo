...
insert into categories (name, product_count, stock_value, last_updated) values
  ('Apparel',          3, '₹4.8L', '2 hours ago'),
  ('Electronics',      3, '₹6.2L', '1 day ago'),
  ('Groceries',        1, '₹3.4L', '30 min ago'),
  ('Accessories',      3, '₹2.1L', '4 hours ago'),
  ('Home & Kitchen',   2, '₹1.9L', 'Yesterday'),
  ('Beauty & Care',    0,  '₹1.2L', '3 hours ago'),
  ('Sports & Fitness', 0,  '₹0.9L', '2 days ago'),
  ('Stationery',       0,  '₹0.4L', '6 hours ago');
...
insert into inventory_dashboard (id, data) values (1, '{
  ...
  "topCategories": [
    { "name": "Apparel", "productCount": 3, "share": 25 },
    { "name": "Electronics", "productCount": 3, "share": 25 },
    { "name": "Accessories", "productCount": 3, "share": 25 },
    { "name": "Home & Kitchen", "productCount": 2, "share": 17 },
    { "name": "Groceries", "productCount": 1, "share": 8 }
  ]
}'::jsonb);

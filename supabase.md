...
| ------------- | ------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Employees     | `supabase/employees/`     | `employees`, `employee_logins`, `employee_activity`, `employee_locations`, `employee_reports`                                                                                                     | `useEmployees(search)`, `useEmployeeProfile(id)`, `useEmployeeLogins(search)`, `useEmployeeActivity(search)`, `useEmployeeLocations()`, `useEmployeeReports()`, `useCreateEmployee()`, `useUpdateEmployee()`, `useDeleteEmployee()` (`src/hooks/use-employees.ts`)   | `Employee`, `EmployeeLogin`, `EmployeeActivity`, `EmployeeLocation`, `EmployeeReport`, `EmployeeProfile` (`src/types/employees.ts`)                                                                      |
